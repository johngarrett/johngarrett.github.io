...
import type { Trip, TripInfo } from "../types";
...
/**
 * parse a trip's info.json file and return it
 */
const getInfo = async (path: string): Promise<TripInfo> => {
